...
$string['hello'] = 'Hallo ';
$string['personal_dashboard'] = 'Willkommen auf deinem persönlichen Dashboard.';
$string['unlocked_activities'] = 'Score der bisher auf Moodle <br> freigeschalteten Aktivitäten';
$string['overview_activities'] = 'Zeitaufteilung';
$string['place_explanations'] = 'Hier wäre Platz für eine Erklärung wie:
                Die Balken zeigen die Anzahl der Studierenden, welche die jeweiligen Aufgaben noch nicht erledigt haben';
$string['total_students'] = 'Studierende Insgesamt';
$string['number_previous_activities'] = 'Anzahl bisheriger Aktivitäten';
$string['number_open_activities'] = 'Anzahl ausstehender Aktivitäten';

$string['mine'] = 'mein Score';
$string['lowest'] = 'niedrigster Peer-Score';
$string['highest'] = 'höchster Peer-Score';
$string['avg'] = 'durchschn. Peer-Score';
$string['total'] = 'Gesamtvergleich';
